"""
Anthropic tool schemas for the Kenya Group Joining Safaris AI Agent (Safi).
...
TOOL_SCHEMAS = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "accommodation_level": {
                    "type": "string",
                    "enum": ["budget", "mid_range", "upmarket", "luxury"],
                    "description": "Preferred accommodation tier",
                },
                "duration_days": {
                    "type": "integer",
                    "description": "Desired safari duration in days",
                },
            },
        },
    },
